...
QT_MOC_LITERAL(1, 12, 13), // "editCompleted"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 11) // "changeTable"

    },
    "SudokuModel\0editCompleted\0\0changeTable"
};
...
void SudokuModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (SudokuModel::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SudokuModel::editCompleted)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void SudokuModel::editCompleted(const QString & _t1)
{
